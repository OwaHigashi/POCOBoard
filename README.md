...
[M5Tab-Poco](https://github.com/OwaHigashi/M5Tab-Poco) の Windows 版移植 — 操作ウィンドウと表示ウィンドウを**別モニタ**に配置するマルチスクリーン構成で、同じ LAN 内にいる視聴者のブラウザから複数人が同時に BOMB / CHEER / HEARTS / STARS / SNOW といった演出を投げ込んだり、画像・動画・MP3 を投稿したり、マイクで喋りかけたりできます。
